...
var codemaps = {
  "script": [119964, 119990, null, null, null, {
    [66]: 8492,
    [69]: 8496,
    [70]: 8497,
    [72]: 8459,
  ...
  "fraktur": [120068, 120094, null, null, null, {
    [67]: 8493,
    [72]: 8460,
    [73]: 8465,
    [82]: 8476,
  ...
  "double-struck": [120120, 120146, 120792, null, null, {
    [67]: 8450,
    [72]: 8461,
    [78]: 8469,
    [80]: 8473,
  ...
  "bold": [119808, 119834, 120782, 120488, 120514],
  "bold-italic": [119912, 119938, null, 120604, 120630],
  "sans-serif": [120224, 120250, 120802],
  "sans-serif-italic": [120328, 120354, 120802],
  "bold-sans-serif": [120276, 120302, 120812, 120662, 120688],
  "sans-serif-bold-italic": [120380, 120406, 120812, 120720, 120746],
...
var AMsymbols = [
  ...
  { input: "hat", tag: "mover", output: "\u0302", tex: null, ttype: 1 /* UNARY */, acc: true },
...
var AsciiMathParser = class {
  ...
  constructor(configuration) {
     ...
     * @type {string}
     */
    __publicField(this, "listseparator", ",");
    /**
  ...
  getSymbol(str) {
    ...
    if (st === "-" && str.charAt(1) !== " " && this.previousSymbol === 3 /* INFIX */) {
      ...
      return { input: st, tag: tagst, output: st == "-" ? "\u2212" : st, tex: null, ttype: 1 /* UNARY */, func: true };
    }
    return { input: st, tag: tagst, output: st == "-" ? "\u2212" : st, tex: null, ttype: 0 /* CONST */ };
  }
  /**
  ...
  parseSexpr(str) {
    ...
    switch (symbol.ttype) {
      ...
      case 1 /* UNARY */:
        ...
        if (symbol.func) {
          st = str.charAt(0);
          if (st === "^" || st === "_" || st === "/" || st === "|" || st === this.listseparator || symbol.input.length === 1 && symbol.input.match(/\w/) && st !== "(") {
            node = this.configuration.create(symbol.tag);
            node.appendChild(this.configuration.createText(symbol.output));
            return [node, str];
          } else {
...
var AMNode = class {
  constructor(t, content = "") {
    ...
    // DOM allows NULL, but not important
    __publicField(this, "parent", null);
    __publicField(this, "childNodes", []);
    __publicField(this, "attributes", {});
    __publicField(this, "style", { fontWeight: "", fontStyle: "" });
    __publicField(this, "unique");
    this.nodeName = t;
    this.nodeValue = content;
    this.unique = /* @__PURE__ */ Symbol();
  }
  appendChild(frag) {
    if (frag.parent !== null) {
...
var AMNodeAdapter = class _AMNodeAdapter {
  ...
  get childNodes() {
    return Array.prototype.slice.call(this.element.childNodes).map(function(n) {
      return new _AMNodeAdapter(n);
    });
  }
  get firstChild() {
    if (this.element.childNodes.length === 0) {
      ...
      return new _AMNodeAdapter(this.element.childNodes[0]);
    }
  }
  get lastChild() {
    if (this.element.childNodes.length === 0) {
      ...
      return new _AMNodeAdapter(this.element.childNodes[this.element.childNodes.length - 1]);
    }
  }
  hasChildNodes() {
...
var AsciiMath = class {
  ...
  setlistseparator(input) {
    this.domConfig.options.listseparator = input;
    this.parser = new AsciiMathParser(this.domConfig);
  }
  parseMath(input) {
    const result = this.parser.mml(input);
    const amnode = result.underlyingNode;
    return "<math>" + amnode.flatten() + "</math>";
  }
};
var asciimath = new AsciiMath();
var ParseToString_default = asciimath;
var parseMath = (input) => asciimath.parseMath(input);
var setdecimal = (input) => asciimath.setdecimal(input);
var setlistseparator = (input) => asciimath.setlistseparator(input);
export {
  AMNode,
  AMNodeAdapter,
  AsciiMath,
  asciimath,
  ParseToString_default as default,
  parseMath,
  setdecimal,
  setlistseparator
};
