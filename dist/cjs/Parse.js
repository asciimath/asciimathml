...
const AsciiMathParser_js_1 = require("./AsciiMathParser.js");
...
const parseMath = (input) => exports.asciimath.parseMath(input);
exports.parseMath = parseMath;
const AMprocessNode = (n, linebreaks, spanclassAM) => exports.asciimath.AMprocessNode(n, linebreaks, spanclassAM);
exports.AMprocessNode = AMprocessNode;
const setdecimal = (input) => exports.asciimath.setdecimal(input);
exports.setdecimal = setdecimal;
const setlistseparator = (input) => exports.asciimath.setlistseparator(input);
