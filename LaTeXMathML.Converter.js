...
LaTeXMathML.Converter.js
==============

this file is a copy of LaTeXMathML.js with editing the following
- Removing the code that prevents IE from "adding MathPlayer info explicitly to each webpage"
- Removing the automatic onload converstion funtion. 
- Exposing the translate function to the public object.
- adding a simple function that converts latex string to MathML string "LatexToMathML(LatexStr)".
