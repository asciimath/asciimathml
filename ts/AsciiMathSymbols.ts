...
export const AMsymbols: Symbol[] = [
  ...
  {input:"\\ ",  tag:"mtext", output:"\u00A0", tex:null, ttype:TokenType.CONST},
  {input:"frown",  tag:"mo", output:"\u2322", tex:null, ttype:TokenType.CONST},
  {input:"quad", tag:"mspace", output:"1", tex:null, ttype:TokenType.CONST},
  ...
  AMquote,
  {input:"bb", ttype:TokenType.UNARY, tex:"mathbf", codes:'bold', tag:"", output:"bb"},
  {input:"sf", ttype:TokenType.UNARY, tex:"mathsf", codes:'sans-serif', tag:"", output:"sf"},
  {input:"sfit", ttype:TokenType.UNARY, tex:null, codes:'sans-serif-italic', tag:"", output:"sfit"},
  {input:"bbsf", ttype:TokenType.UNARY, tex:null, codes:'bold-sans-serif', tag:"", output:"bbsf"},
  {input:"bbb", ttype:TokenType.UNARY, tex:"mathbb", codes:'double-struck', tag:"", output:"bbb"},
  {input:"cc", ttype:TokenType.UNARY, tex: "mathcal", codes:'script', tag:"", output:"cc"},
  {input:"bbcc", ttype:TokenType.UNARY, tex:null, codes:'bold-script', tag:"", output:"bbcc"},
  {input:"tt", ttype:TokenType.UNARY, tex:"mathtt", codes:'monospace', tag:"", output:"tt"},
  {input:"fr", ttype:TokenType.UNARY, tex:"mathfrak", codes:'fraktur', tag:"", output:"fr"},
  {input:"bbfr", ttype:TokenType.UNARY, tex:null, codes:'bold-fraktur', tag:"", output:"bbfr"},
  {input:"bbit", ttype:TokenType.UNARY, tex:null, codes:'bold-italic', tag:"", output:"bbit"},
  {input:"bbsfit", ttype:TokenType.UNARY, tex:null, codes:'sans-serif-bold-italic', tag:"", output:"bbsfit"},
  {input:"bold", tex:null, ttype:TokenType.UNARY, codes:'bold', tag:"", output:"bold"}];
